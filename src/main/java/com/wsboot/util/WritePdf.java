...
public class WritePdf {
		...
		public void writePdf(String texto) throws IOException {
			 ...
			 */
			PDFObject text = new PDFObject(19, 0);
			text.addKey("Length", Integer.toString(texto.getBytes().length));
			text.addTextStream("F1", 8, 0, 0, texto);
	 
			/**
			 * Create page object with above font & text
			 */
			PDFObject page = new PDFObject(4, 0, "Page");
			 ...
			 */
			PDFObject pages = new PDFObject(3, 0, "Pages");
			pages.addKey("Count", "1");
			//pages.addKey("MediaBox", "[0 0 300 144]");
			pages.addKey("MediaBox", "[0 0 600 288]");
